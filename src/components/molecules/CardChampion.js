...
function CardChampion({id, name, title, tags}) {
    ...
    <div className='flex  flex-col champion px-2 w-36 mb-3'>
        <div className='duration-300 flex flex-col justify-end items-end w-20 h-20 md:w-24 md:h-24 bg-center bg-cover bg-no-repeat mb-1' style={{ backgroundImage: `url('${imgData}')` }}>
